...
- you can specify several valid HTTP methods while registering a handler, for example `fxhttpserver.AsHandler("GET,POST", ...)`
...
- you can specify several valid HTTP methods while registering a handler in a group, for example `fxhttpserver.NewHandlerRegistration("GET,POST", ...)`
