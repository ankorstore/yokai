...
[![codecov](https://codecov.io/gh/ankorstore/yokai/graph/badge.svg?token=5s0g5WyseS&flag=generate)](https://app.codecov.io/gh/ankorstore/yokai/tree/main/modules%2Fgenerate)
...
```shell
go get github.com/ankorstore/yokai/modules/generate
```
...
import (
	...
	"github.com/ankorstore/yokai/modules/generate/uuid"
	uuidtest "github.com/ankorstore/yokai/modules/generate/generatetest/uuid"
)
